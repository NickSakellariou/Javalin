<template id="checkout-not-signed-in">
	<div>
		...
		<div class="checkoutRow">
			...
			<hr>
			<form method="post" action="/api/insert-purchase-not-signed-in">
...
<script>
    Vue.component("checkout-not-signed-in", {
    	template: "#checkout-not-signed-in",
    	data: () => ({
    		usernames: [],
    		cookies: [],
        }),
