<template id="login-failure1">
	<div>
		...
		<br>
		<br>
		<div class="loginFailure1Row">
			<h2>This username does not exist, try again</h2>
		</div>
		<div class="loginFailure1Footer">
			&copy;
...
<script>
	Vue.component("login-failure1", {
	    template: "#login-failure1",
	});
</script>
