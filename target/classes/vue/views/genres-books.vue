<template id="genres-books">
	<div>
		...
		<div v-if="books.length>0">
			<div v-for="(book, key) in books" class="genresBooksRow1">
				<div v-if="key == books.length - 1">
					<h1>{{book.genre}} books</h1>
				</div>
			</div>
		</div>
		<br>
		...
		<div v-if="books.length == 0">
			<div class="genresBooksRow">
				<h2>There are no books in this genre yet</h2>
			</div>
		</div>
		
		<div class="genresBooksRow3">
			<div v-for="book in books">
				<div class="genresBooksRow2">
					<div>
						<br>
...
<script>
    Vue.component("genres-books", {
    	template: "#genres-books",
    	data: () => ({
    		usernames: [],
    		books: [],
        }),
