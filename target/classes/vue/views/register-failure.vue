<template id="register-failure">
	<div>
		...
		<br>
		<br>
		<div class="registerFailureRow">
			<h2>E-mail or username already exists, try something else</h2>
		</div>
		<div class="registerFailureFooter">
			&copy;
...
<script>
	Vue.component("register-failure", {
	    template: "#register-failure",
	});
</script>
